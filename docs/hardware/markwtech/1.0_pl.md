...
4. **Kalibracja baterii:** naładuj ogniwo do pełna przez port USB-C ładowarki (dioda na module zmieni kolor). Diagnostyka powinna pokazać napięcie ogniwa koło 4,2 V i ADC około 2600. Tylko gdy tak nie jest, skopiuj `sug` z Diagnostyki i wgraj `make flash VARIANT=markwtech BATTERY_FACTOR=<suggested_factor>`.
