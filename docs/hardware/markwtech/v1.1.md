...
**Do not** add TP4056, a Pololu, or a 47 kΩ divider. TinyC6 already charges the cell, regulates 3.3 V, and measures battery on GPIO 4 (442 kΩ / 160 kΩ). Firmware uses the same empirical ADC-count scale as v1.0 (factor **1.7**), not the resistor ratio.
