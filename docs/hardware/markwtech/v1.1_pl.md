...
**Nie** dokładasz TP4056, Pololu ani dzielnika 47 kΩ. TinyC6 już ładuje ogniwo, reguluje 3,3 V i mierzy baterię na GPIO 4 (442 kΩ / 160 kΩ). Firmware używa tej samej empirycznej skali zliczeń ADC co v1.0 (współczynnik **1,7**), nie stosunku rezystorów.
